const Spinner = () => {
	return (
		<svg xmlns="http://www.w3.org/2000/svg" style={{ margin: 'auto', background: 'rgb(255, 255, 255, 0)', display: 'block', shapeRendering: 'auto' }} width="71px" height="71px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
